 ...
 describe('Activity Controller Unit Tests:', function() {
   ...
   request(app)
    ...
    describe('Testing the GET methods', function() {
       it('Should be able to get the list of actitities', function(done){
       ...
       it('Should be able to get the specific activity', function(done) {
         ...
         it('Should be not able to get myActivity list without logging in', function(done){
         ...
         it('Should be able to get myActivity list when logging in', function(done){
         request(app).get('/api/myActivity')
           .set('Accept', 'application/json')
    ...
    describe('Testing the PUT methods', function() {
       it('Should be able to participate without problems', function(done){
        var data = {
          aid:activity.id
        }         
       ...
       it('Should not be able to participate activity without logging in', function(done) {
        var data = {
          aid:activity.id
        }  
         request(app).put('/api/participate')
         ...
         it('Should be not able to participate activity without activity id', function(done){
         request(app).put('/api/participate')
           .set('Accept', 'application/json')
           .expect('Content-Type', /json/)
           .set('Authorization', 'Bearer ' + token)
         ...
         it('Should be not able to view users participated activity without activity id', function(done){
         ...
         it('Should be not able to view users participated activity without an admin account', function(done){
       var normaltoken;
    ...
    describe('Testing the POST methods', function() {
       it('Should be able to put an activity without problems', function(done){
        var activityData = {
                "title": "New Activity",
       ...
       it('Should be not able to put an activity without logging in', function(done){
        var activityData = {
                "title": "New Activity",
                "description": "please come and see",
                "start": '2016-11-25T12:00:00.000Z',
    ...
    it('Should be not able to put an activity with volunteer account', function(done){
       var normaltoken;
       var normaluser = new User({
         name: 'testName',
         telephone: '123456789',
